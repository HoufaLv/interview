            ...
            <div class="box">
                <div class="box-body">
                    <form method="post" id="saveForm">
                        ...
                        <input type="hidden" id="storeManagerAttachment" name="storeManagerIdentity" value="${ticketStore.storeManagerIdentity}">
                        <input type="hidden" id="storeAttachment" name="storeIdentity" value="${ticketStore.storeIdentity}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="photo" id="userPhoto">
                                    <img src="http://p7h7vnjez.bkt.clouddn.com/${ticketStore.storeManagerIdentity}-preview" alt="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div id="picker2">选择营业执照照片</div>
                                <div class="photo" id="storePhoto">
                                    <img src="http://p7h7vnjez.bkt.clouddn.com/${ticketStore.storeIdentity}-preview" alt="">
                                </div>
                            </div>
                        </div>
